...
latex_documents = [
    (master_doc, 'solt.tex', 'solt Documentation',
     'Aleksei Tiulpin', 'manual'),
]
...
man_pages = [
    (master_doc, 'solt', 'solt Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'solt', 'solt Documentation',
     author, 'solt', 'One line description of project.',
     'Miscellaneous'),
]
